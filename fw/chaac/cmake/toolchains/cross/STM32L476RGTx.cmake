...
if(STM32L476RTGx_TOOLCHAIN_INCLUDED)
	return()
endif()

set(STM32L476RTGx_TOOLCHAIN_INCLUDED true)

set(CPU_NAME STM32L476RTGx)

set(LINKER_SCRIPT_DIR ${CMAKE_SOURCE_DIR}/cmake/linker-scripts/stm)
set(LINKER_SCRIPT_PRIMARY_FILE STM32L476RTGx_FLASH.ld)
