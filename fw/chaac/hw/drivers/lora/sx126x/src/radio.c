...
void RadioInit( RadioEvents_t *events )
{
    ...
    os_cputime_timer_init(&TxTimeoutTimer, RadioOnTxTimeoutIrq, NULL);
    os_cputime_timer_init(&RxTimeoutTimer, RadioOnRxTimeoutIrq, NULL);
...
void RadioSend( uint8_t *buffer, uint8_t size )
{
    ...
    os_cputime_timer_relative(&TxTimeoutTimer, TxTimeout * 1000);
...
void RadioSetTxContinuousWave( uint32_t freq, int8_t power, uint16_t time )
{
    ...
    os_cputime_timer_stop(&RxTimeoutTimer);
    os_cputime_timer_relative(&RxTimeoutTimer, time * 1000 * 1000);
...
void RadioOnRxTimeoutIrq( void  * unused)
{
